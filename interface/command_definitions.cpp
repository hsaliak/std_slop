  ...
  static const std::vector<CommandDefinition> kDefinitions = {
      ...
      {"/session",
       ...
       {"/session list          List all unique session names in the DB",
        "/session switch <name>    Switch to or create a new session named <name>",
      ...
      {"/review",
       ...
       {},
       {"/review                Show the review dashboard.",
        "/review session        Review uncommitted session changes. Add comments with 'R:' to instruct the LLM.",
        "/review mail           Review all patches in the current mail-series.",
        "/review mail <n>       Review a specific patch in the series.",
        "/review mail approve   Approve the current patchset for finalization.",
        "/review git <ref>      Review changes from a specific git ref (e.g., HEAD~1 or main)."},
       "Context & History"},
      {"/feedback",
       {},
       {},
