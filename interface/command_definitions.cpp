...
const std::vector<CommandDefinition>& GetCommandDefinitions() {
  static const std::vector<CommandDefinition> kDefinitions = {
      ...
      {"/session", {"list", "switch", "remove", "clear", "clone", "scratchpad"}, {}, {"/session list", "/session switch <name>", "/session remove <name>", "/session clear", "/session clone <name>", "/session scratchpad read", "/session scratchpad edit"}, "Session & Memory"},
      {"/agents_md", {"show", "reload"}, {"/memo"}, {"/agents_md show", "/agents_md reload [path]"}, "Session & Memory"}, 
