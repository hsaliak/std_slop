  ...
  static const std::vector<CommandDefinition> kDefinitions = {
      ...
      {"/review",
       ...
       {"/review                Review session changes (git only). Add comments with 'R:' to instruct the LLM.",
        "/review mail [n]       Review patches in a mail-series (Mail Mode only)",
        "/review mail approve   Approve the current patchset for finalization (Mail Mode only)",
        "/review <n>            Review changes from HEAD~n",
        "/review <ref>          Review changes from a specific git ref"},
       "Context & History"},
      {"/feedback",
       {},
       {},
