...
std::string GetCliHelpText() {
  std::string help =
      ...
      "- `--prompt -`: Read a single batch-mode prompt from stdin and exit.\n"
      "- `--prompt-file <path>`: Read a single batch-mode prompt from a file and exit.\n"
      "- `--prompt-stdin`: Read a single batch-mode prompt from stdin and exit.\n"
