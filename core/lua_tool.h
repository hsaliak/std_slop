...
using ToolDispatchMap =
    absl::flat_hash_map<std::string, std::function<absl::StatusOr<std::string>(const nlohmann::json&,
...
void InitializeEnvironment(sol::state& lua, Database* db, ToolDispatcher* dispatcher,
