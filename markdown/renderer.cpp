...
Style GetNodeStyle(std::string_view type, bool use_ansi_styles) {
  ...
  static constexpr SyntaxMap kSyntaxStyles[] = {
      ...
      {"local", {Keyword, ansi::Reset}},
      {"nil", {Keyword, ansi::Reset}},
      {"then", {Keyword, ansi::Reset}},
      {"until", {Keyword, ansi::Reset}},
      {"do", {Keyword, ansi::Reset}},
      {"end", {Keyword, ansi::Reset}},
      {"elseif", {Keyword, ansi::Reset}},
      {"and", {Keyword, ansi::Reset}},
      {"or", {Keyword, ansi::Reset}},
      {"not", {Keyword, ansi::Reset}},
      {"in", {Keyword, ansi::Reset}},
      ...
      {"integer_literal", {Number, ansi::Reset}},
      {"float_literal", {Number, ansi::Reset}},
      {"function", {Function, ansi::Reset}},
      {"function_definition", {Function, ansi::Reset}},
      {"local_function_definition", {Function, ansi::Reset}},
      {"function_declaration", {Function, ansi::Reset}},
      {"local_function_declaration", {Function, ansi::Reset}},
      ...
      {"field_identifier", {Variable, ansi::Reset}},
      {"variable_name", {Variable, ansi::Reset}},
      {"command_name", {Function, ansi::Reset}},
      {"char_literal", {String, ansi::Reset}},
