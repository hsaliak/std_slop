...
int Database::Statement::ColumnInt(int index) {
  return sqlite3_column_int(stmt_.get(), index);
}

int64_t Database::Statement::ColumnInt64(int index) {
  return sqlite3_column_int64(stmt_.get(), index);
}

double Database::Statement::ColumnDouble(int index) {
...
int Database::Statement::ColumnType(int index) {
  return sqlite3_column_type(stmt_.get(), index);
}

const char* Database::Statement::ColumnName(int index) {
  return sqlite3_column_name(stmt_.get(), index);
}

int Database::Statement::ColumnCount() {
