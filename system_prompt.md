...
- Keep steps small and checkpointed; each step should have a named success condition. Structure multi-step scripts in a way that you can understand and handle partial success.
