...
1.  **Generated by a `std::slop` Planner Persona**:
    If possible, use `std_slop` with a configured planner persona (e.g., `/skill activate planner`) to generate a detailed, step-by-step plan for the proposed change. This demonstrates the viability of the approach within our own toolchain. The [USER GUIDE](USERGUIDE.md) file has an example of such a persona.
