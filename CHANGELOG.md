...
- **MCP command-line workflow**: Added `std_slop mcp add`, `list`, `oauth-login`, `oauth-refresh`, `logout`, `remove`, and `help` commands for configuring and operating MCP servers.
